...
<head>
	...
	<title>Uporabniško področje - RKJ Sežana</title>
	<meta name="description" content="Uporabniško področje - nastavitve, posodobitve in več">
	<?php $html->head(); ?>
		...
		<?php

			{
				if (isset($_GET['par1'])&&!empty($_GET['par1'])){
					echo '<script>document.title="Uporabniško področje - '.$_GET['par1'].' - RKJ Sežana";</script>';
					$path = __DIR__ . '/inc/pages/user-'.$_GET['par1'].'.php';
					if (file_exists($path)){
						include_once $path;
					} else {
